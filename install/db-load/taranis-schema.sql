---
--- This schema is loaded by the installtion scripts when there is no
--- database found

--- (Was?) only needed during reading this scheme
...
INSERT INTO taranis VALUES ('schema_version', 3459);
