...
function moveOptionToLeft(event) {
	var button = event.target;
	var rightColumn = $(button).parent().siblings('div').children('.select-right');
	var leftColumn = $(button).parent().siblings('div').children('.select-left');

	rightColumn.children('option:selected').each( function(index) {
		$(this).off('dblclick').on('dblclick', function () { $('.btn-option-to-right').trigger('click') } );
...
function moveOptionToRight(event) {
	var button = event.target;
	var rightColumn = $(button).parent().siblings('div').children('.select-right');
	var leftColumn = $(button).parent().siblings('div').children('.select-left');

	leftColumn.children('option:selected').each( function(index) {
		$(this).off('dblclick').on('dblclick', function () { $('.btn-option-to-left').trigger('click') } );
