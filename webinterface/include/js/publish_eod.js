...
function openDialogPublishEodCallback ( params ) {
	...
	$.main.activeDialog.dialog('option', 'buttons', [
		{
			...
			click: function () {
				$.main.ajaxRequest({
					...
					success: refreshPublicationList({pub_type: 'eod'})
				});
		...
		},
		{
			...
			click: function () {
				...
				$.main.ajaxRequest({
					...
					queryString: 'id=' + params.publicationId + '&publicationType=eod&publicationText=' + publicationText,
					success: publishEod
				});
			}
		},
