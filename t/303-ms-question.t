...
#warn "QUESTION=", Dumper $question;
#warn "EXPECTED=", Dumper $expected;
...
try_question 'mixture certids', " $example_ids[0] +$example_ids[1]  -$example_ids[2]", {
	...
	bonus_words      => [ $example_ids[0] ],
	required_words   => [ $example_ids[1] ],
	excluded_words   => [ $example_ids[2] ],
	has_certids      => 3,
	has_words        => 3,
	has_bonus        => 1,
	has_required     => 1,
