			...
			withEphemeralDatabase {
				...
				# Test getLatestAdvisoryVersion.
				{
					always_show $got, $exp unless cmp_deeply(
						$got = Publication->getLatestAdvisoryVersion("TEST-$year-0001"),
						$exp = superhashof({
					...
					always_show $got, $exp unless cmp_deeply(
						$got = Publication->getLatestAdvisoryVersion("TEST-$year-0002"),
						$exp = superhashof({
					...
					always_show $got, $exp unless cmp_deeply(
						$got = Publication->getLatestAdvisoryVersion("TEST-$year-0005"),
						$exp = undef,
