...
=head2 getIssuesSimple( \%where )

Retrieves a list of issues same as getIssues(), but with less options. Typically used as follows:

    $obj->getIssuesSimple( { group_id => 34, status => [0,1] } );
