...
# Retrieve the ID that is set in table `publication_type` for the specified type name.
...
# processPreviewTemplatePart( $json_str, $table_name )
# Create a part of the preview.
# Parameter $json_str consists of:
# * ids, ID's of the records to retrieve
# * columns, the column names of the desired information
# * destination (single value), destination id on HTML page
#
